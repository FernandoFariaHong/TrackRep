...
CREATE TABLE usuarios (
    ...
    -- Meta corporal do usuário
    objetivo_corporal ENUM('ganhar_massa', 'perder_peso', 'manter_peso') DEFAULT 'manter_peso',
...
SELECT
    COUNT(*) AS total_registros_corporais
FROM
    historico_corporal;